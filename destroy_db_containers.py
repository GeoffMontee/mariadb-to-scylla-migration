#!/usr/bin/env python3
"""
Destroy MariaDB and ScyllaDB containers and associated Docker resources.
"""
...
def main():
    ...
    print("=" * 60)
    print("Destroying MariaDB to ScyllaDB Migration Infrastructure")
    print("=" * 60)

    # Configuration
    mariadb_container_name = "mariadb-migration-source"
    scylla_container_name = "scylladb-migration-target"
    network_name = "migration-network"

    # Remove MariaDB container
    print("\n[1/3] Removing MariaDB container...")
    remove_container(client, mariadb_container_name)
    ...
    print("To rebuild from scratch, run: python3 start_db_containers.py --rebuild")
...
if __name__ == "__main__":
    ...
    print("  - MariaDB container (mariadb-migration-source)")
